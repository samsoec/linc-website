        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid gap-12 md:grid-cols-2 md:gap-16">
                ...
                <div>
                  {visionMission.visionHeading && (
                    <h2 className="mb-6 text-xl font-semibold text-white md:text-4xl lg:text-2xl">
                      {visionMission.visionHeading}
                    </h2>
                  )}
                  {visionMission.visionDescription && (
                    <>
                      <p className="mb-6 text-3xl font-semibold leading-relaxed text-white md:text-5xl">
                        {visionMission.visionDescription}
                      </p>
          ...
          {coreValues && (
            <div>
              ...
              {/* Heading */}
              {coreValues.heading && (
                <h2 className="mb-6 text-2xl font-semibold text-white md:text-left md:text-4xl lg:text-4xl">
                  {coreValues.heading}
                </h2>
              )}
              ...
              {coreValues.description && (
                <>
                  ...
                  <div className="mb-12 h-1 w-16 rounded-full bg-white" />
                </>
              )}
