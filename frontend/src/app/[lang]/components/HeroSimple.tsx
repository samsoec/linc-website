      ...
      <section className="relative w-full py-20 md:py-32">
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center text-center">
            {/* Breadcrumbs */}
            <nav className="mb-8 flex flex-wrap items-center justify-center gap-2 text-sm font-medium">
            ...
            {/* Title */}
            <h1
              className={`text-4xl sm:text-5xl md:text-6xl font-semibold leading-tight sm:leading-tight md:leading-tight mb-6 max-w-4xl ${
            ...
            {data.description && (
              <p
                className={`text-base sm:text-lg md:text-xl leading-relaxed sm:leading-relaxed md:leading-relaxed mb-6 max-w-3xl ${
